...
namespace ChilliSoftAssessmentMeetingMinuteTakerMVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var model = new ChilliSoftAssessmentMeetingMinuteTakerDLL.ViewModels.CreateUserViewModel()
                {
